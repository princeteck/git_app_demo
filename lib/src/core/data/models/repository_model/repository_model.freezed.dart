...
abstract class _RepositoryModel implements RepositoryModel {
  factory _RepositoryModel(
      ...
      @JsonKey(name: 'watchers')
          final int? watchers,
      @JsonKey(name: 'default_branch')
          final String? defaultBranch}) = _$_RepositoryModel;
