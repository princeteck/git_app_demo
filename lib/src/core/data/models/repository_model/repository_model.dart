...
class RepositoryModel with _$RepositoryModel {
  factory RepositoryModel({
    ...
    @JsonKey(name: 'gitTags_url') String? gitTagsUrl,
    @JsonKey(name: 'gitRefs_url') String? gitRefsUrl,
    ...
    @JsonKey(name: 'gitCommits_url') String? gitCommitsUrl,
    @JsonKey(name: 'comments_url') String? commentsUrl,
    @JsonKey(name: 'issueComment_url') String? issueCommentUrl,
